...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    notification_preferences: Attribute.Component<'notifications.notification-preferences'>;
    device_info: Attribute.Component<'device.device-info', true>;
...
export interface ApiPoojaPooja extends Schema.CollectionType {
  ...
  attributes: {
    ...
    currentParticipants: Attribute.Integer;
    ...
    en_description: Attribute.Text;
    en_photos: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRefundRefund extends Schema.SingleType {
